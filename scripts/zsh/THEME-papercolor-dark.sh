...
gconftool-2 --set /apps/gnome-terminal/profiles/base-16-papercolor-dark/font --type=string "Droid Sans Mono 11"
# choose this profile as the default
gconftool-2 --set --type string /apps/gnome-terminal/global/default_profile ${PROFILE_SLUG}
